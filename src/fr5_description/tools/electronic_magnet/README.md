...
```bash
roslaunch fr5_description display_arm_rviz.launch tool_name:=electronic_magnet
```

### 在Gazebo中使用

```bash
roslaunch fr5_description display_dual_arm_rviz.launch arm1_tool:=electronic_magnet arm2_tool:=electronic_magnet
```
