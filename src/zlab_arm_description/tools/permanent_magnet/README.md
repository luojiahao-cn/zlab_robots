...
```bash
roslaunch zlab_arm_description display_arm_rviz.launch tool_name:=permanent_magnet
```

### 在Gazebo中使用

```bash
roslaunch zlab_arm_description display_dual_arm_rviz.launch arm1_tool:=permanent_magnet arm2_tool:=permanent_magnet
```
