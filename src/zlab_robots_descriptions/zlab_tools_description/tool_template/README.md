...
```bash
# 测试单个工具
roslaunch fr5_description display_arm_rviz.launch tool_name:=your_tool_name

# 测试双臂工具
roslaunch fr5_description display_dual_arm_rviz.launch arm1_tool:=your_tool_name arm2_tool:=your_tool_name
```

## 包结构说明

这些工具统一放在 `zlab_tools_description` 包中：

- **主包**: `zlab_tools_description`
- **工具目录**: `zlab_tools_description/your_tool_name/`
- **配置访问**: 通过 `zlab_tools_description` 包访问
- **文件路径**: `package://zlab_tools_description/your_tool_name/...`
